...
class ScreenRulesGameContent extends StatelessWidget {
  const ScreenRulesGameContent({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          BlocBuilder<RulesBloc, RulesState>(builder: (context, state) {
            return ListView(
